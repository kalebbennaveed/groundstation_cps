...
bool px4_msgs__msg__trajectory_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // raw_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "raw_mode");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->raw_mode = (Py_True == field);
    Py_DECREF(field);
  }
  {  // cmd
...
PyObject * px4_msgs__msg__trajectory_setpoint__convert_to_py(void * raw_ros_message)
{
  ...
  {  // raw_mode
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->raw_mode ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "raw_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
