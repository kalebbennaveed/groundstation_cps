...
class Init_TrajectorySetpoint_cmd
{
public:
  explicit Init_TrajectorySetpoint_cmd(::px4_msgs::msg::TrajectorySetpoint & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::TrajectorySetpoint cmd(::px4_msgs::msg::TrajectorySetpoint::_cmd_type arg)
  {
...
class Init_TrajectorySetpoint_raw_mode
{
public:
  explicit Init_TrajectorySetpoint_raw_mode(::px4_msgs::msg::TrajectorySetpoint & msg)
  : msg_(msg)
  {}
  Init_TrajectorySetpoint_cmd raw_mode(::px4_msgs::msg::TrajectorySetpoint::_raw_mode_type arg)
  {
    msg_.raw_mode = std::move(arg);
    return Init_TrajectorySetpoint_cmd(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_TrajectorySetpoint_raw_mode yawspeed(::px4_msgs::msg::TrajectorySetpoint::_yawspeed_type arg)
  {
    msg_.yawspeed = std::move(arg);
    return Init_TrajectorySetpoint_raw_mode(msg_);
  }
