...
struct TrajectorySetpoint_
{
  ...
  explicit TrajectorySetpoint_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->yawspeed = 0.0f;
      this->raw_mode = false;
      std::fill<typename std::array<float, 4>::iterator, float>(this->cmd.begin(), this->cmd.end(), 0.0f);
    }
  }
  ...
  using _raw_mode_type =
    bool;
  _raw_mode_type raw_mode;
  using _cmd_type =
    std::array<float, 4>;
  _cmd_type cmd;
  ...
  bool operator==(const TrajectorySetpoint_ & other) const
  {
    ...
    if (this->raw_mode != other.raw_mode) {
      return false;
    }
