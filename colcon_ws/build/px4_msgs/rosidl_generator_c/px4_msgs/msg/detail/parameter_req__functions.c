...
{
  px4_msgs__msg__ParameterReq * msg = (px4_msgs__msg__ParameterReq *)malloc(sizeof(px4_msgs__msg__ParameterReq));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4_msgs__msg__ParameterReq));
  bool success = px4_msgs__msg__ParameterReq__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    px4_msgs__msg__ParameterReq__fini(msg);
  }
  free(msg);
}
...
px4_msgs__msg__ParameterReq__Sequence__init(px4_msgs__msg__ParameterReq__Sequence * array, size_t size)
{
  ...
  px4_msgs__msg__ParameterReq * data = NULL;
  if (size) {
    data = (px4_msgs__msg__ParameterReq *)calloc(size, sizeof(px4_msgs__msg__ParameterReq));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4_msgs__msg__ParameterReq__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4_msgs__msg__ParameterReq__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
px4_msgs__msg__ParameterReq__Sequence__fini(px4_msgs__msg__ParameterReq__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4_msgs__msg__ParameterReq__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  px4_msgs__msg__ParameterReq__Sequence * array = (px4_msgs__msg__ParameterReq__Sequence *)malloc(sizeof(px4_msgs__msg__ParameterReq__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = px4_msgs__msg__ParameterReq__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    px4_msgs__msg__ParameterReq__Sequence__fini(array);
  }
  free(array);
}
...
px4_msgs__msg__ParameterReq__Sequence__are_equal(const px4_msgs__msg__ParameterReq__Sequence * lhs, const px4_msgs__msg__ParameterReq__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__ParameterReq__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__ParameterReq__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__ParameterReq);
    px4_msgs__msg__ParameterReq * data =
      (px4_msgs__msg__ParameterReq *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__ParameterReq__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__ParameterReq__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__ParameterReq__copy(
