...
size_t size_function__TrajectorySetpoint__cmd(const void * untyped_member)
{
  (void)untyped_member;
  return 4;
}

const void * get_const_function__TrajectorySetpoint__cmd(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TrajectorySetpoint__cmd(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectorySetpoint_message_member_array[9] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::TrajectorySetpoint, raw_mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::TrajectorySetpoint, cmd),  // bytes offset in struct
    nullptr,  // default value
    size_function__TrajectorySetpoint__cmd,  // size() function pointer
    get_const_function__TrajectorySetpoint__cmd,  // get_const(index) function pointer
    get_function__TrajectorySetpoint__cmd,  // get(index) function pointer
    nullptr  // resize(index) function pointer
  }
};
