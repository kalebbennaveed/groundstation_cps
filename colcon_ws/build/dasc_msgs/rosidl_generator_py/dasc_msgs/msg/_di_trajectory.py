...
class Metaclass_DITrajectory(type):
    """Metaclass of message 'DITrajectory'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dasc_msgs.msg.DITrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__di_trajectory
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__di_trajectory
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__di_trajectory
            cls._TYPE_SUPPORT = module.type_support_msg__msg__di_trajectory
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__di_trajectory
...
class DITrajectory(metaclass=Metaclass_DITrajectory):
    """Message class 'DITrajectory'."""
    ...
    _fields_and_field_types = {
        ...
        'twists': 'sequence<geometry_msgs/Twist>',
        'accelerations': 'sequence<geometry_msgs/Accel>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Accel')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'twists' field must be a set or sequence and each value of type 'Twist'"
        self._twists = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, Accel) for v in value) and
                 True), \
                "The 'accelerations' field must be a set or sequence and each value of type 'Accel'"
