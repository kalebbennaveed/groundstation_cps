...
static const _DITrajectory_type_support_symbol_names_t _DITrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dasc_msgs, msg, DITrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dasc_msgs, msg, DITrajectory)),
  }
};
...
{
  return &::dasc_msgs::msg::rosidl_typesupport_cpp::DITrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dasc_msgs, msg, DITrajectory)() {
  return get_message_type_support_handle<dasc_msgs::msg::DITrajectory>();
}
